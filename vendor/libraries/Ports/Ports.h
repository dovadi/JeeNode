...
// $Id: Ports.h 4887 2010-03-22 23:09:59Z jcw $
...
class HeadingPlug : public PortI2C {
    ...
    void getConstants();
    word adcValue(byte type) const;

public:
    HeadingPlug (int num)
        : PortI2C (num), eeprom (*this, 0x50), adc (*this, 0x77), aux (5-num) {}
    
    void begin();
    void readout(int& temp, int& pres) const;
};
